...
d3.csv("hw2/state.csv", function(error, cars) {
      ...
      var cols = {"name": "State", "population": "Population", "life_expectancy": "Life Expectancy", "income": "Income", 
        ...
        console.log(cols["population"])

  cars.forEach(function(d){ d.color = colorScale(d.region) })
  ...
  g.append("g")
      .attr("class", "axis")
      .each(function(d) { console.log(d); d3.select(this).call(axis.scale(y[d])); })
    .append("text")
  ...
  g.append("g")
    ...
    var colors = d3.entries(create_colors(cars))
